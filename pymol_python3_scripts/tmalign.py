...
def tmalign(mobile, target, args='', exe='/home/huabai/bin/TMalign', ter=0, transform=1, object=None, quiet=0):
    '''
DESCRIPTION
...
def tmscore(mobile, target, args='', exe='/home/huabai/bin/TMalign', quiet=0, **kwargs):
    '''
DESCRIPTION
